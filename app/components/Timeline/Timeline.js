    ...
    <>
        ...
        <div className={styles.description}>
          ...
          <>
            ...
            <p>
              ...
              working in Bollywood with Rensil D'Silva on his Cop-Thriller film
              Dial 100 starring Manoj Bajpayee, Neena Gupta and Sakshi Tanwar,
              after which he joined Rajiv Menon Productions to collaborate and
              develop several stories with filmmaker Rajiv Menon, based in
              Chennai.
            </p>
            ...
            <p>
              ...
              Nair, Majid Majidi, Stephen Spielberg, Kim Ki-Duk, Christopher
      ...
      <div className={styles.smallScreen}>
        <p>
          <span> Sarath Menon</span>, a professional filmmaker, screenwriter,
          visual artist and poet, is an alumnus of The London Film School and
          BITS Pilani. Sarath started his artistic journey writing and acting in
          plays in early childhood. A passion that grew with him, developed into
          a profession as his relationship with visual storytelling evolved in
          his days at BITS Pilani Goa campus where he completed his dual degrees
          in Chemical Engineering and a masters in Chemistry.
          {!readMore && (
            <button
